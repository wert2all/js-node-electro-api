...
export default class UIInit {
    ...
    _appendGApi(window) {
        ...
        new DomScript(window.document).create(this._config.getGoogleConfig().getApiUrl());
    }
     ...
     */
    _initUI(document) {
        const defaultAuthValues = new UiAuthElementDefaultValues("../assets/img/avatar.svg", "John Doe");
        ...
        const authElement = new UIAuthElementComposite([
            new UIAuthElement(
                new UiAuthNodesHolder(
                    ...
                    document.querySelector("#userprofile_container ul.uk-nav a.profile_link"),
                    document.querySelector("#userprofile_container ul.uk-nav a.profile_sign_out")
                ),
                defaultAuthValues
            ),
            new UIAuthElement(
        ...
        const content = new UIContentElement(document.querySelector("#content .uk-container.uk-container-expand"));
    ...
    _makeImageItem(document, api, authProvider, profile) {
        ...
        const uiItemConfig = new UIImageItemConfig(
            ...
            new UIImageItemConfigRadio(".uk-card-body label.uk-switch", ".uk-card-body label.uk-switch input"),
        ...
        const imageItem = new UIImageItem(
            ...
            new UIImageActionsModifierComposite([
                ...
                new UIImageActionModifier(
                    ...
                    new UIImageDeleteAction(new UIConfirm(UIkit), api, authProvider, this._ui.getNotify())
                ),
                new UIImageActionModifier(
                    new DomListenersModifier(),
    ...
    _makeImageList(api, authProvider, profile) {
         ...
         * @type {UIImageItem}
         */
        const imageItem = this._makeImageItem(document, api, authProvider, profile);
    ...
    _makeAuthElements(authProvider, profile) {
        ...
        this._ui.getAuthElement().applyProfileClick((user) => profile.show(user));
    }
    ...
    _createProfileElementViewHolder(selector) {
        return new DomFormElementViewHolder(
            ...
            document.querySelector("#modal_profile .uk-form-controls." + selector + " .uk-label")
        );
    }
